...
function LaserableLeather() {
            ...
            useEffect(() => {
                fetch('http://localhost:3001/api/products')
                    ...
                    .then(data => {
                        // Filter products that belong to the laserable leather category for standard users
                        const filteredProducts = isAdmin ? data : data.filter(product => product.category_id === 6);
        ...
        export default LaserableLeather;