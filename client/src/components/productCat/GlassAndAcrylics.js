...
function GlassAndAcrylics() {
            ...
            useEffect(() => {
                fetch('http://localhost:3001/api/products')
                    ...
                    .then(data => {
                        // Filter products that belong to the glass and acrylics category for standard users
                        const filteredProducts = isAdmin ? data : data.filter(product => product.category_id === 3);
...
export default GlassAndAcrylics;